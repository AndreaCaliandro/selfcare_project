...
med_risk_dict_codes['detalproblem'] = ['J024.11','J025000','J026.00','J027.11','J031.11','J043.11','J043.14','J043C00','J046.00','J046300','J046400','J046500','J05..00']
...
#Check all patients appearances of all the risk factors in med file
patient_cv_data = {}
for patients in patientsDictList:
    patientdict = {}
    patientdict['sex'] = patients['sex']
...
codesperpatient = []
for keys in patient_cv_data.keys():
    codesperpatient.append(len(patient_cv_data[keys]))
